...
export const findEmailSchema = {
  ...
  description:
    "Scrapes a company website to find a contact email. Checks the main page, contact page, and tries common patterns like contact@, info@, etc.",
  inputSchema: {
    type: "object",
    properties: {
      website_url: {
...
export async function handleFindEmail(args: { website_url: string }): Promise<string> {
