...
export const setupNotionSchema = {
  ...
  description:
    "Migrates your Notion database — creates all required columns (Company, Website, Email, Type, Status, Date Sent, Notes). Run this once after adding NOTION_DATABASE_ID to your .env. Safe to call again.",
  inputSchema: {
    type: "object",
    properties: {},
    required: [],
