...
export const parseProfileSchema = {
    name: "parse_profile",
    description: "Parses a CV, resume, or profile text and extracts your skills, experience, role, and strengths. Pass either a file path or raw text.",
    inputSchema: {
        type: "object",
        properties: {
            input: {
