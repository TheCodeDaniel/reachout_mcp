...
export const setupNotionSchema = {
    ...
    description: "Creates the Cold Outreach Tracker database in Notion. Run this once. After running, copy the returned database ID into NOTION_DATABASE_ID in your .env file.",
    inputSchema: {
        type: "object",
        properties: {},
        required: [],
