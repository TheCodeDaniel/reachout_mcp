...
export const researchCompanySchema = {
    ...
    description: "Scrapes a company website and uses AI to analyze their product, find pain points, and recommend the best email type (opportunity_pitch or role_inquiry).",
    inputSchema: {
        type: "object",
        properties: {
            website_url: {
...
export async function handleResearchCompany(args) {
...
//# sourceMappingURL=researchCompany.js.map